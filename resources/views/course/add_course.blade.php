                ...
                <div class="card-body card-bottom">
                    <form action="/course/add" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control mt-1" type="text" name="course_name" value="{{ old('course_name') }}" placeholder="Course Name">
                        ...
                        <div class="form-group mt-4">
                            ...
                            <input class="form-control mt-1" type="text" name="course_code" value="{{ old('course_code') }}" placeholder="Course Code">
                            <small class="validation-message">
                                @error('course_code')
                                    {{ $message }}
                                @enderror
                        ...
                        <div class="form-group mt-4">
                            ...
                            <input class="form-control mt-1" type="text" name="course_duration" value="{{ old('course_duration') }}" placeholder="Course Duration">
                            <small class="validation-message">
