...
--
-- Host: localhost
-- Generation Time: Jul 17, 2022 at 07:23 AM
...
(1, '2022_07_17_025013_create_courses_table', 1),
(2, '2022_07_17_024956_create_students_table', 2),
(3, '2022_07_17_025042_create_subjects_table', 3),
(4, '2022_07_17_025057_create_exam_marks_table', 4);
...
ALTER TABLE `exam_marks`
  ...
  ADD KEY `exam_marks_courseid_foreign` (`courseID`),
...
--
ALTER TABLE `exam_marks`
  ADD CONSTRAINT `exam_marks_courseid_foreign` FOREIGN KEY (`courseID`) REFERENCES `courses` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `exam_marks_studentid_foreign` FOREIGN KEY (`studentID`) REFERENCES `students` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `exam_marks_subjectid_foreign` FOREIGN KEY (`subjectID`) REFERENCES `subjects` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `students`
--
ALTER TABLE `students`
  ADD CONSTRAINT `students_courseid_foreign` FOREIGN KEY (`courseID`) REFERENCES `courses` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `subjects`
--
ALTER TABLE `subjects`
  ADD CONSTRAINT `subjects_courseid_foreign` FOREIGN KEY (`courseID`) REFERENCES `courses` (`id`) ON DELETE CASCADE;
COMMIT;
